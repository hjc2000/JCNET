...
int i = 0;
ReadOnlyMemory<char> memory = str.ReplaceTwoWord("function", "Servo.SetSpeedAndRun", $"G[{i++}] = function");
memory = memory.ReplaceTwoWord("function", "Servo.SetAbsolutePositionAndRun", $"G[{i++}] = function");
memory = memory.ReplaceTwoWord("function", "Servo.PresetPosition", $"G[{i++}] = function");
memory = memory.ReplaceTwoWord("function", "Servo.CancelPositioning", $"G[{i++}] = function");
memory = memory.ReplaceTwoWord("function", "Servo.Stop", $"G[{i++}] = function");
